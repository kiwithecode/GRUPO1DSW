    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          <li><a href="../../GRUPO1DSW/index.php" class="nav-link px-2 text-secondary">Home</a></li>
        ...
        <div class="text-end">
          <a type="button" href="../../GRUPO1DSW/login/login.php" class="btn btn-outline-light me-2">Iniciar Sesión</a>
          <a type="button" href="../../GRUPO1DSW/login/signup.php" class="btn btn-info">Crear cuenta nueva</a>
        </div>
      </div>
    </div>
</header>
